          ...
          <div className="md:w-10/12 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-4">
              <TeamCard
                ...
                detail={
                  "Babasola Aluko is a seasoned professional with over 20 years banking experience. <br />He started his banking career in Standard Chartered bank as a relationship officer in one of the branches. His experience in banking was largely in customer facing units and relationship management. He was the Head of Financial Institutions and International Organizations at Ecobank Nigeria. He held the position for 5years before resigning in 2019. While at Ecobank Nigeria, he broadened the Bank’s relationship with offshore banks and coordinated the Bank’s debut loan syndication where the Bank raised over $150 million from foreign banks. He has been involved in several entrepreneurial activities after disengaging from banking. <br />He currently has interests in Mining, Agriculture, real estate both in Nigeria and abroad. <br />He is currently a director at Blue Square Limited, a real estate development company and on the board of other companies. <br />Babasola has a B.Eng (Hons) in Civil Engineering from University of Ilorin and MBA (Marketing) from the Obafemi Awolowo University."
                }
              />
              <TeamCard
                name={"Morayo Oyeleke"}
              ...
              <TeamCard
                ...
                pic={"/assets/blank.png"}
                detail={
                  "Fidel Okwuokei is a licensed architect with the architect registration council of Nigeria and a trained facility manager from the United kingdom. <br />He has a vast knowledge of the construction industry from design to contract administration and post construction management. He has been in the business for over 20 years, with key emphasis on details and internationally acceptable standards in construction industry, complex residential projects, commercial and hospitality sector. <br /> Some of the companies he has worked with include Shell, the Nigerian stock exchange , Metro West, Templar's , Novartis, design Union amongst others.<br /> He has a master's degree in architecture from the University of jos Nigeria and a master's degree in Facility management from the Heriot Watt University in Scotland."
                }
              />
              <TeamCard
