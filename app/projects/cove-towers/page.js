    ...
    <div className={`flex flex-col bg-white`}>
      ...
      <section className=" flex sticky top-40 pr-20 md:mb-[-300px] w-fit self-end">
        ...
        <div className="shadow-2xl hidden sticky top-10 p-4 md:flex flex-col gap-2 bg-white my-[-100px]  w-[27vw]">
          ...
          <Link
            href={
              "https://drive.google.com/uc?export=download&id=191EZ8XQCqPwAEg3AzXqQ379JZV0pTsct"
            }
          ...
          <div className={`flex gap-2 p-2`}>
            ...
            <div className="flex flex-col">
              ...
              <p className={`text-sm`}>
                ...
                <Link
                  href={
                    "https://drive.google.com/file/d/12Qtfm5xVkNz4NhXAhxhMlTSNrZswVmDG/view?usp=drive_link"
                  }
                >
