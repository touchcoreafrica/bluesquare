...
export default function Page() {
  ...
  const siteImages = [
    "/assets/lunar-courts-site1.png",
    "/assets/lunar-courts-site2.png",
    "/assets/lunar-courts-site3.png",
    "/assets/lunar-courts-site4.png",
  ];
  ...
  return (
    <div className={`flex flex-col bg-white`}>
      <section className="h-[85vh] w-full bg-cover bg-[url('/assets/lunar-court-banner.png')] flex items-center justify-center">
        <motion.div
          ...
          <div className={`flex gap-2 p-2`}>
            ...
            <div className="flex flex-col">
              ...
              <p className={`text-sm text-[#6D6E71]`}>
                8 units of 2 & 3 bedrooms apartments <br /> 6 units of 4 bedroom
                detached houses.
              </p>
            </div>
          </div>
      ...
      <section className="flex items-center md:px-20 p-4 overflow-visible py-5 gap-4">
        <div className="flex flex-col gap-5 md:w-[70%]">
          <div className="flex flex-col">
            ...
            <p className={`bodyFont text-3xl text-[#CAA969]`}>Lunar Courts</p>
          </div>
          <div className="flex flex-col gap-4">
            <p className={`bodyFont text-[#6D6E71] leading-[190%]`}>
              This gorgeous nearly perfect estate was designed with innovation
              in mind. Despite being built in 2013, its timeless features and
              dazzling interior finishes remain modern and relevant, regardless
              of the season.
            </p>
            <p className={`bodyFont text-[#6D6E71] leading-[190%]`}>
              Lunar Court is not just where you live, it’s where you relax,
              rejuvenate, and connect with family, situated in Oniru Private
              Estate Victoria Island Lagos. This property features 8 units of 2
              and 3 bedroom apartments, 6 units of 4 bedroom detached houses.
            </p>
          </div>
        </div>
      ...
      <section className={`hidden p-4 md:p-20 gap-4 headerFont`}>
      ...
      >
        <div className={`flex justify-between`}>
          ...
          <p className={`headerFont text-2xl text-[#CAA969]`}>Lunar Courts</p>
        </div>
