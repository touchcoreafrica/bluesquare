      ...
      <section className="flex items-center md:px-20 p-4 overflow-visible py-5 md:py-20 gap-4">
        <div className="flex flex-col gap-5 md:w-[70%] md:pt-[120px]">
          <div className="flex flex-col">
            ...
            <p className={`headerFont text-3xl text-[#CAA969]`}>Gazania Park</p>
          </div>
        ...
        <div className="md:w-[70%] flex flex-col">
          ...
          <div className="md:grid grid-cols-2 gap-4 flex overflow-scroll w-full">
            ...
            {/*             <ApartmentCard
              ...
              images={[
                "/assets/GazaniaParkThreeBedroomMaisonette1.svg",
                "/assets/GazaniaParkThreeBedroomMaisonette2.svg",
                "/assets/GazaniaParkThreeBedroomMaisonette3.svg",
                "/assets/GazaniaParkThreeBedroomMaisonette4.svg",
                "/assets/GazaniaParkThreeBedroomMaisonette5.svg",
              ]}
              squareFoot={236}
              bedroom={3}
              bath={3}
